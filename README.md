...
1. 공공데이터포털	(79,005 데이터셋)
1. 유통 빅데이터	(18,001 데이터셋)
1. 대구광역시	(14,199 데이터셋)
1. 금융데이터거래소	(10,687 데이터셋)
1. 서울특별시	(8,025 데이터셋)
1. 경기도	(4,557 데이터셋)
1. 인천광역시	(3,780 데이터셋)
1. 경상남도	(3,128 데이터셋)
1. 소방안전 빅데이터	(3,053 데이터셋)
1. 부산광역시	(2,968 데이터셋)
1. 데이터 스토어	(2,540 데이터셋)
1. 헬스케어 빅데이터	(2,020 데이터셋)
1. 전라북도	(1,932 데이터셋)
1. 지역경제 빅데이터	(1,413 데이터셋)
1. 라이프로그 빅데이터	(1,389 데이터셋)
1. 문화 빅데이터	(1,382 데이터셋)
1. 제주도	(1,241 데이터셋)
1. 해양수산 빅데이터	(1,160 데이터셋)
1. 환경 빅데이터	(1,047 데이터셋)
1. 교통데이터 오픈마켓	(994 데이터셋)
1. 농림축산식품 공공데이터	(903 데이터셋)
1. 국가공간정보포털	(815 데이터셋)
1. 산림 빅데이터	(764 데이터셋)
1. AI 허브	(752 데이터셋)
1. 디지털 산업혁신 빅데이터	(750 데이터셋)
1. 통신 빅데이터	(694 데이터셋)
1. 농식품 빅데이터	(663 데이터셋)
1. 중소기업 빅데이터	(660 데이터셋)
1. 강원도	(498 데이터셋)
1. 스마트치안 빅데이터	(460 데이터셋)
1. 공간융합 빅데이터 플랫폼	(404 데이터셋)
1. 금융 빅데이터	(393 데이터셋)
1. 부산 빅데이터	(319 데이터셋)
1. 서울특별시 빅데이터	(318 데이터셋)
1. 경상북도	(315 데이터셋)
1. 스마트팜 빅데이터 플랫폼	(251 데이터셋)
1. 고속도로 공공데이터 포털	(245 데이터셋)
1. 감염병 빅데이터 플랫폼	(233 데이터셋)
1. 데이터안심구역	(220 데이터셋)
1. 쿠콘 API	(196 데이터셋)
