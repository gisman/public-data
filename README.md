...
1. 4.대구 D-데이터허브	(10,065 데이터셋)
1. 4.부산 공공데이터 포털	(2,591 데이터셋)
1. 4.전라북도 빅데이터 허브	(1,927 데이터셋)
1. 4.제주데이터허브	(1,011 데이터셋)
1. 8.LH 택지정보	(17 데이터셋)
1. 9.교통 빅데이터 플랫폼	(294 데이터셋)
1. 9.금융 빅데이터 플랫폼	(781 데이터셋)
1. 9.산림 빅데이터 플랫폼	(729 데이터셋)
1. AI 허브	(193 데이터셋)
1. 기미나인	(3 데이터셋)
1. 농림축산식품 공공데이터 포털	(551 데이터셋)
1. 농식품 빅데이터	(273 데이터셋)
...
1. 소방안전 빅데이터	(995 데이터셋)
1. 스마트치안 빅데이터	(296 데이터셋)
...
1. 해양수산 빅데이터	(304 데이터셋)
1. 헬스케어 빅데이터 플랫폼	(4,094 데이터셋)
1. 환경 빅데이터 플랫폼	(2,737 데이터셋)
