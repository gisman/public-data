...
1. 공공데이터포털 (81,641데이터셋)
1. 유통 빅데이터 (19,516데이터셋)
1. 대구광역시 (15,475데이터셋)
1. 금융데이터거래소 (13,200데이터셋)
1. 미국 (9,727데이터셋)
1. 서울특별시 (8,041데이터셋)
1. 경기도 (4,759데이터셋)
1. 인천광역시 (4,583데이터셋)
...
1. 부산광역시 (2,617데이터셋)
1. 헬스케어 빅데이터 (2,021데이터셋)
1. 지역경제 빅데이터 (1,677데이터셋)
1. 문화 빅데이터 (1,398데이터셋)
1. 농식품 빅데이터 (1,343데이터셋)
1. 제주도 (1,301데이터셋)
1. 해양수산 빅데이터 (1,171데이터셋)
1. 환경 빅데이터 (1,104데이터셋)
1. 교통데이터 오픈마켓 (1,008데이터셋)
...
1. 통신 빅데이터 (696데이터셋)
1. 중소기업 빅데이터 (664데이터셋)
1. 공간융합 빅데이터 플랫폼 (662데이터셋)
1. 농림축산식품 공공데이터 (635데이터셋)
1. 브이월드 (625데이터셋)
1. 스마트치안 빅데이터 (456데이터셋)
1. 연안 빅데이터 플랫폼 (423데이터셋)
1. 스마트팜 빅데이터 플랫폼 (404데이터셋)
1. 금융 빅데이터 (400데이터셋)
1. 서울특별시 빅데이터 (321데이터셋)
1. 부산 빅데이터 (319데이터셋)
1. 데이터안심구역 (275데이터셋)
