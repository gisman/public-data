...
1. 공공데이터포털 (81,247 데이터셋)
1. 유통 빅데이터 (19,507 데이터셋)
1. 대구광역시 (15,022 데이터셋)
1. 금융데이터거래소 (13,117 데이터셋)
1. 미국 (9,727 데이터셋)
1. 서울특별시 (7,966 데이터셋)
1. 경기도 (4,753 데이터셋)
1. 인천광역시 (4,578 데이터셋)
1. 충청남도 (4,514 데이터셋)
1. 소방안전 빅데이터 (3,079 데이터셋)
1. 경상남도 (2,940 데이터셋)
1. 전라북도 (2,650 데이터셋)
1. 부산광역시 (2,617 데이터셋)
...
1. 제주도 (1,301 데이터셋)
1. 농식품 빅데이터 (1,280 데이터셋)
1. 해양수산 빅데이터 (1,171 데이터셋)
1. 환경 빅데이터 (1,097 데이터셋)
1. 교통데이터 오픈마켓 (1,008 데이터셋)
1. 라이프로그 빅데이터 (817 데이터셋)
1. 산림 빅데이터 (786 데이터셋)
