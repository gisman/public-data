...
1. 1.공공데이터포털	(57,303 데이터셋)
1. 1.지방행정 인허가 데이터개방	(36 데이터셋)
1. 2.국가공간정보포털	(793 데이터셋)
1. 2.서울특별시	(7,185 데이터셋)
1. 3.경기도	(1,514 데이터셋)
1. 3.인천데이터포털	(2,551 데이터셋)
1. 4.강원 공공데이터	(501 데이터셋)
1. 4.경상남도	(2,283 데이터셋)
1. 4.경상북도 공공데이터	(315 데이터셋)
1. 4.대구 D-데이터허브	(9,691 데이터셋)
1. 4.부산 공공데이터 포털	(2,603 데이터셋)
...
1. AI 허브	(191 데이터셋)
1. 기미나인	(4 데이터셋)
1. 농림축산식품 공공데이터 포털	(502 데이터셋)
1. 농식품 빅데이터	(356 데이터셋)
1. 데이터 스토어	(2,495 데이터셋)
1. 디지털 산업혁신 빅데이터	(688 데이터셋)
1. 라이프로그 빅데이터	(856 데이터셋)
1. 무역투자 빅데이터 서비스	(10 데이터셋)
1. 문화 빅데이터 플랫폼	(1,852 데이터셋)
1. 소방안전 빅데이터	(1,255 데이터셋)
1. 스마트치안 빅데이터	(624 데이터셋)
1. 유통 빅데이터 플랫폼	(26,007 데이터셋)
1. 중소기업 빅데이터 플랫폼	(861 데이터셋)
1. 지역경제 빅데이터 플랫폼	(1,359 데이터셋)
1. 카톨릭빅데이터통합센터	(62 데이터셋)
1. 쿠콘	(170 데이터셋)
1. 통신 빅데이터 플랫폼	(816 데이터셋)
1. 한국관광 Data Lab	(40 데이터셋)
1. 해양수산 빅데이터	(305 데이터셋)
1. 헬스케어 빅데이터 플랫폼	(5,222 데이터셋)
1. 환경 빅데이터 플랫폼	(2,597 데이터셋)
