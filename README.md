...
1. 4.부산 공공데이터 포털	(2,578 데이터셋)
1. 4.전라북도 빅데이터 허브	(1,926 데이터셋)
1. 4.제주데이터허브	(834 데이터셋)
1. 8.LH 택지정보	(17 데이터셋)
...
1. AI 허브	(190 데이터셋)
1. 기미나인	(2 데이터셋)
1. 농림축산식품 공공데이터 포털	(544 데이터셋)
1. 농식품 빅데이터	(265 데이터셋)
1. 데이터 스토어	(2,507 데이터셋)
1. 디지털 산업혁신 빅데이터	(536 데이터셋)
1. 라이프로그 빅데이터	(419 데이터셋)
1. 무역투자 빅데이터 서비스	(10 데이터셋)
1. 문화 빅데이터 플랫폼	(1,828 데이터셋)
1. 소방안전 빅데이터	(759 데이터셋)
...
1. 쿠콘	(170 데이터셋)
1. 통신 빅데이터 플랫폼	(624 데이터셋)
1. 한국관광 Data Lab	(40 데이터셋)
1. 해양수산 빅데이터	(220 데이터셋)
1. 헬스케어 빅데이터 플랫폼	(4,094 데이터셋)
1. 환경 빅데이터 플랫폼	(2,466 데이터셋)
