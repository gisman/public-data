# [대한민국 공공데이터 서비스](https://www.gimi9.com) 
...
1. 공공데이터포털	(73,709 데이터셋)
1. 유통 빅데이터	(17,267 데이터셋)
1. 대구광역시	(13,940 데이터셋)
1. 금융데이터거래소	(11,989 데이터셋)
1. 서울특별시	(7,984 데이터셋)
1. 헬스케어 빅데이터	(4,568 데이터셋)
1. 인천광역시	(3,601 데이터셋)
1. 경상남도	(2,980 데이터셋)
1. 부산광역시	(2,864 데이터셋)
1. 문화 빅데이터	(2,743 데이터셋)
1. 소방안전 빅데이터	(2,611 데이터셋)
1. 데이터 스토어	(2,540 데이터셋)
1. 해양수산 빅데이터	(2,321 데이터셋)
1. 전라북도	(1,932 데이터셋)
1. 경기도	(1,598 데이터셋)
1. 디지털 산업혁신 빅데이터	(1,530 데이터셋)
1. 산림 빅데이터	(1,527 데이터셋)
1. 통신 빅데이터	(1,386 데이터셋)
1. 라이프로그 빅데이터	(1,374 데이터셋)
1. 중소기업 빅데이터	(1,329 데이터셋)
1. 지역경제 빅데이터	(1,300 데이터셋)
1. 제주도	(1,240 데이터셋)
1. 환경 빅데이터	(1,089 데이터셋)
1. 스마트치안 빅데이터	(906 데이터셋)
1. 농림축산식품 공공데이터	(884 데이터셋)
1. 농식품 빅데이터	(845 데이터셋)
1. 국가공간정보포털	(815 데이터셋)
1. 금융 빅데이터	(781 데이터셋)
1. AI 허브	(752 데이터셋)
1. 강원도	(498 데이터셋)
1. 교통데이터 오픈마켓	(476 데이터셋)
1. 쿠콘 API	(386 데이터셋)
1. 공간융합 빅데이터 플랫폼	(370 데이터셋)
1. 서울특별시 빅데이터	(369 데이터셋)
1. 경상북도	(315 데이터셋)
1. 부산 빅데이터	(309 데이터셋)
1. 스마트팜 빅데이터 플랫폼	(250 데이터셋)
1. 데이터안심구역	(220 데이터셋)
1. 감염병 빅데이터 플랫폼	(210 데이터셋)
1. 부동산 빅데이터 플랫폼	(174 데이터셋)
1. 연안 빅데이터 플랫폼	(160 데이터셋)
1. 카톨릭병원 빅데이터	(130 데이터셋)
1. 데이터루트 KB 카드	(94 데이터셋)
1. 한국관광 Data Lab	(80 데이터셋)
1. 통계데이터센터	(50 데이터셋)
1. 공간빅데이터분석 플랫	(41 데이터셋)
1. 인허가	(36 데이터셋)
1. 데이터스 롯데카드	(25 데이터셋)
1. 무역투자 빅데이터	(20 데이터셋)
1. 택지정보	(17 데이터셋)
