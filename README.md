...
1. 공공데이터포털	(79,687 데이터셋)
1. 금융데이터거래소	(28,092 데이터셋)
1. 유통 빅데이터	(18,917 데이터셋)
1. 대구광역시	(14,643 데이터셋)
1. 서울특별시	(8,063 데이터셋)
1. 경기도	(4,582 데이터셋)
1. 인천광역시	(3,790 데이터셋)
1. 소방안전 빅데이터	(3,165 데이터셋)
1. 경상남도	(3,141 데이터셋)
1. 부산광역시	(2,981 데이터셋)
1. 데이터 스토어	(2,540 데이터셋)
1. 헬스케어 빅데이터	(2,021 데이터셋)
1. 전라북도	(2,017 데이터셋)
1. 지역경제 빅데이터	(1,527 데이터셋)
1. 라이프로그 빅데이터	(1,400 데이터셋)
1. 문화 빅데이터	(1,398 데이터셋)
1. 제주도	(1,250 데이터셋)
1. 해양수산 빅데이터	(1,161 데이터셋)
1. 환경 빅데이터	(1,053 데이터셋)
1. 교통데이터 오픈마켓	(999 데이터셋)
1. 농림축산식품 공공데이터	(904 데이터셋)
1. 농식품 빅데이터	(838 데이터셋)
1. 국가공간정보포털	(815 데이터셋)
1. 산림 빅데이터	(774 데이터셋)
...
1. AI 허브	(752 데이터셋)
1. 통신 빅데이터	(696 데이터셋)
1. 중소기업 빅데이터	(661 데이터셋)
1. 공간융합 빅데이터 플랫폼	(587 데이터셋)
1. 강원도	(498 데이터셋)
1. 스마트치안 빅데이터	(462 데이터셋)
1. 금융 빅데이터	(400 데이터셋)
1. 부산 빅데이터	(319 데이터셋)
1. 서울특별시 빅데이터	(318 데이터셋)
1. 경상북도	(315 데이터셋)
1. 스마트팜 빅데이터 플랫폼	(308 데이터셋)
1. 고속도로 공공데이터 포털	(245 데이터셋)
1. 감염병 빅데이터 플랫폼	(239 데이터셋)
1. 데이터안심구역	(222 데이터셋)
1. 연안 빅데이터 플랫폼	(217 데이터셋)
1. 쿠콘 API	(196 데이터셋)
1. 부동산 빅데이터 플랫폼	(183 데이터셋)
1. 데이터루트 KB 카드	(95 데이터셋)
1. 카톨릭병원 빅데이터	(66 데이터셋)
