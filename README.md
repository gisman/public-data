...
1. 1.공공데이터포털	(48,313 데이터셋)
1. 1.지방행정 인허가 데이터개방	(36 데이터셋)
1. 2.국가공간정보포털	(793 데이터셋)
1. 2.서울특별시	(7,095 데이터셋)
1. 3.경기도	(1,488 데이터셋)
1. 3.인천데이터포털	(2,536 데이터셋)
1. 4.강원 공공데이터	(501 데이터셋)
1. 4.경상남도	(2,137 데이터셋)
1. 4.경상북도 공공데이터	(315 데이터셋)
1. 4.대구 D-데이터허브	(9,698 데이터셋)
1. 4.부산 공공데이터 포털	(2,552 데이터셋)
1. 4.전라북도 빅데이터 허브	(1,925 데이터셋)
1. 4.제주데이터허브	(806 데이터셋)
1. 8.LH 택지정보	(17 데이터셋)
1. 9.교통 빅데이터 플랫폼	(293 데이터셋)
1. 9.금융 빅데이터 플랫폼	(672 데이터셋)
1. 9.산림 빅데이터 플랫폼	(624 데이터셋)
1. AI 허브	(190 데이터셋)
1. 기미나인	(4 데이터셋)
1. 농식품 빅데이터	(242 데이터셋)
1. 데이터 스토어	(2,500 데이터셋)
1. 디지털 산업혁신 빅데이터	(517 데이터셋)
1. 라이프로그 빅데이터	(414 데이터셋)
1. 무역투자 빅데이터 서비스	(10 데이터셋)
1. 문화 빅데이터 플랫폼	(1,760 데이터셋)
1. 소방안전 빅데이터	(755 데이터셋)
1. 스마트치안 빅데이터	(158 데이터셋)
1. 유통 빅데이터 플랫폼	(24,203 데이터셋)
1. 중소기업 빅데이터 플랫폼	(689 데이터셋)
1. 지역경제 빅데이터 플랫폼	(1,073 데이터셋)
1. 카톨릭빅데이터통합센터	(60 데이터셋)
1. 쿠콘	(170 데이터셋)
1. 통신 빅데이터 플랫폼	(619 데이터셋)
1. 한국관광 Data Lab	(40 데이터셋)
1. 해양수산 빅데이터	(198 데이터셋)
1. 헬스케어 빅데이터 플랫폼	(3,283 데이터셋)
1. 환경 빅데이터 플랫폼	(2,371 데이터셋)
