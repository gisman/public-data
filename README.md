...
1. 공공데이터포털	(79,301 데이터셋)
1. 금융데이터거래소	(21,914 데이터셋)
1. 유통 빅데이터	(18,646 데이터셋)
1. 대구광역시	(14,405 데이터셋)
1. 서울특별시	(8,027 데이터셋)
1. 경기도	(4,576 데이터셋)
1. 인천광역시	(3,780 데이터셋)
1. 소방안전 빅데이터	(3,145 데이터셋)
1. 경상남도	(3,138 데이터셋)
1. 부산광역시	(2,980 데이터셋)
...
1. 환경 빅데이터	(1,048 데이터셋)
1. 교통데이터 오픈마켓	(997 데이터셋)
