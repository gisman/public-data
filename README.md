...
1. 1.공공데이터포털	(48,385 데이터셋)
1. 1.지방행정 인허가 데이터개방	(36 데이터셋)
1. 2.국가공간정보포털	(753 데이터셋)
1. 2.서울특별시	(7,059 데이터셋)
1. 3.경기도	(1,468 데이터셋)
1. 3.인천데이터포털	(1,717 데이터셋)
1. 4.강원 공공데이터	(501 데이터셋)
1. 4.경상남도	(1,846 데이터셋)
1. 4.경상북도 공공데이터	(294 데이터셋)
1. 4.대구 D-데이터허브	(8,163 데이터셋)
1. 4.부산 공공데이터 포털	(2,426 데이터셋)
1. 4.전라북도 빅데이터 허브	(1,877 데이터셋)
1. 8.LH 택지정보	(17 데이터셋)
